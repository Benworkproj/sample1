...
<html>
<head>
	<title>Men's Arnis & Karate</title>
	<link rel="stylesheet" type="text/css" href="arniskmen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-chess">
	 	<h1 class="chess">Men's Arnis & Karate</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Bajade, Jheric</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Tabion, Ian Jose</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Magbanua, Jeff Daniel</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Osila, Ralf Jefferson</p>
		</div>

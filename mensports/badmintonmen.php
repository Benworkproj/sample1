...
<html>
<head>
	<title>Men's Futsal</title>
	<link rel="stylesheet" type="text/css" href="badmintonmen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-futsal">
	 	<h1 class="futsal">Men's Badminton</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Cielo, Ivan Louis</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Cielo, Levy Jr</p>
		</div>

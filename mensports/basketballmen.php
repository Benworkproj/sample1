...
<head>
	...
	<link rel="stylesheet" type="text/css" href="basketballmen.css">
</head>
...
<section class="header">
	...
	<div class="text-basketball"> 
		<h1 class="basketball">Men's Basketball</h1>
	</div>

	<div class="text-roster">
		<h1 class="roster">2023 Official Roster</h1>
	</div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Aguilar, Paolo</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Borda, Mark Vincent</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Castillo, Dhanick</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Dado, John Patrick</p>
		</div>

		<div class="img-5">
			<img class="real-img-5" src="img/profile.jpg">
				<p class="desc">Delos Santos, Ken</p>
		</div>

		<div class="img-6">
			<img class="real-img-6" src="img/profile.jpg">
				<p class="desc">Depetillo, Emmanuel</p>
		</div>


		<div class="img-7">
			<img class="real-img-7" src="img/profile.jpg">
				<p class="desc">Dionisio, Dhane</p>
		</div>


		<div class="img-8">
			<img class="real-img-8" src="img/profile.jpg">
				<p class="desc">Delos Santos, Joven</p>
		</div>

		<div class="img-9">
			<img class="real-img-9" src="img/profile.jpg">
				<p class="desc">Larosa, Norween</p>
		</div>

		<div class="img-10">
			<img class="real-img-10" src="img/profile.jpg">
				<p class="desc">Oliveros, Joharby</p>
		</div>

		<div class="img-11">
			<img class="real-img-11" src="img/profile.jpg">
				<p class="desc">Perez, Nicko</p>
		</div>

		<div class="img-12">
			<img class="real-img-12" src="img/profile.jpg">
				<p class="desc">Quilop, Henry</p>
		</div>
	...
	<div class="text-basketball-3x3"> 
		<h1 class="basketball-3x3">Men's Basketball 3x3</h1>
	</div>

	<div class="text-roster-3x3">
		<h1 class="roster-3x3">2023 Official Roster</h1>
	</div>
	...
	<div class="container-1">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Pondar, Kenneth</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Reyes, Jepson</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Sucgang, Albert</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Ordonez, Jedd Andrew</p>
		</div>

...
<html>
<head>
	<title>Men's Billiards</title>
	<link rel="stylesheet" type="text/css" href="billiardsmen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-billiards">
	 	<h1 class="billiards">Men's Billiards</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Bartolome, Gene Mathew</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Araque, John Oniel</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Estacion, Jomar</p>
		</div>

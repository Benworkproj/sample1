...
<html>
<head>
	<title>Men's Chess</title>
	<link rel="stylesheet" type="text/css" href="chessmen.css">
</head>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Jimenez, Shawn</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Jorolan, Vince Louper</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Manolong, Adrianne</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Vergara, John Bryan</p>
		</div>

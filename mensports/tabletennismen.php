...
<html>
<head>
	<title>Men's Table Tennis</title>
	<link rel="stylesheet" type="text/css" href="tennismen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-chess">
	 	<h1 class="chess">Men's Table Tennis</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Bagunu, Raffy</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Pilapil, March Jujan</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Randrup, Jan Jose</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Silva, Keith Owen</p>
		</div>
	</div>
	...
	<div class="container-lawn">
		<div class="lawn">
    <h1 class="text-lawn">Men's Lawn Tennis</h1>
    <h1 class="official">2023 Official Roster</h1>
    </div>
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Esiritu, John Axl Rick</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Yap, Omni</p>
		</div>
  </div>
</body>

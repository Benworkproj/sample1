...
<html>
<head>
	<title>Women's Arnisk</title>
	<link rel="stylesheet" type="text/css" href="arniskwomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-chess">
	 	<h1 class="chess">Women's Arnisk</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Casal, Catherine</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Catanaoan, Rinoa Jayn</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Villamor, Charm Brianne</p>
		</div>

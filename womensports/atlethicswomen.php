...
<html>
<head>
	<title>Women's Atlethics</title>
	<link rel="stylesheet" type="text/css" href="atlethicswomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-atlethics">
	 	<h1 class="atlethics">Women's Atlethics</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Aguinaldo, Carlea Maria</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Borbe, Elaine</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Chan, Allyssah Danielle</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Pablo, Jemaica</p>
		</div>

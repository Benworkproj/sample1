...
<html>
<head>
	<title>Women's Badminton</title>
	<link rel="stylesheet" type="text/css" href="badmintonwomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-futsal">
	 	<h1 class="futsal">Women's Badminton</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Bersalona, Angel Kaye</p>
		</div>

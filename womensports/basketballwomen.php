...
<head>
	...
	<link rel="stylesheet" type="text/css" href="basketballwomen.css">
</head>
...
<section class="header">
	...
	<div class="text-basketball"> 
		<h1 class="basketball">Women's Basketball</h1>
	</div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Abelardo, Danica</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Autes, Feramie Joy</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Bajamundi, Whenda Jane</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Buenviaje, Yuki Ariza</p>
		</div>

		<div class="img-5">
			<img class="real-img-5" src="img/profile.jpg">
				<p class="desc">Cabillan, Darren</p>
		</div>

		<div class="img-6">
			<img class="real-img-6" src="img/profile.jpg">
				<p class="desc">Dumaraos, Ma. Rosario</p>
		</div>


		<div class="img-7">
			<img class="real-img-7" src="img/profile.jpg">
				<p class="desc">Fuentes, Arlyn</p>
		</div>


		<div class="img-8">
			<img class="real-img-8" src="img/profile.jpg">
				<p class="desc">Guiam, Leslie Mae </p>
		</div>

		<div class="img-9">
			<img class="real-img-9" src="img/profile.jpg">
				<p class="desc">Labajata, Lea</p>
		</div>

		<div class="img-10">
			<img class="real-img-10" src="img/profile.jpg">
				<p class="desc">Murillo, Pamela </p>
		</div>

		<div class="img-11">
			<img class="real-img-11" src="img/profile.jpg">
				<p class="desc">Samson, Alyson</p>
		</div>

		<div class="img-12">
			<img class="real-img-12" src="img/profile.jpg">
				<p class="desc">Sialongo, Jannela Roann</p>
		</div>
	</div>

	<div class="text-basketball-3x3">
		<h1 class="basketball-3x3">Women's Basketball 3x3</h1>
		<h1 class="text-roster-3x3">2023 Official Roster</h1>		
	</div>

	<div class="container-3x3-1">

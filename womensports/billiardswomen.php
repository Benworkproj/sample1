...
<html>
<head>
	<title>Women's Billiards</title>
	<link rel="stylesheet" type="text/css" href="billiardswomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-billiards">
	 	<h1 class="billiards">Women's Billiards</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Bakilid, Cherly Vic</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Galvez, Althea Joy</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Wahing, Marjorie</p>
		</div>

...
<html>
<head>
	<title>Women's Chess</title>
	<link rel="stylesheet" type="text/css" href="chesswomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-chess">
	 	<h1 class="chess">Women's Chess</h1>
	 </div>

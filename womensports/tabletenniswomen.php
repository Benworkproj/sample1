...
<html>
<head>
	<title>Women's Table Tennis</title>
	<link rel="stylesheet" type="text/css" href="tabletenniswomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-chess">
	 	<h1 class="chess">Women's Table Tennis</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Conde, Miraflor</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Danao, Carla Mae</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Quinones, Leila Leslie</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Socao, Gwyneth Grace</p>
		</div>
	</div>
<!-- Lawns tennis -->
	 <div class="text-billiards">
	 	<h1 class="billiards">Women's Lawn Tennis</h1>
	 </div>

	<div class="lawn-roster">
		<h1 class="roster">2023 Official Roster</h1>
	</div>
	...
	<div class="container-1">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Arimado, Micah Nicole</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Domingo, Arnica</p>
		</div>
	</div>
</body>
<footer>

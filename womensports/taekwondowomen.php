...
<html>
<head>
	<title>Women's Taekwondo</title>
	<link rel="stylesheet" type="text/css" href="taekwondowomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-chess">
	 	<h1 class="chess">Women's Taekwondo</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Macrohon, Sharina Acel</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Monasterial, Amelia Kristina</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Pacatang, Dianna Jane Elizabeth</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Ragodon, Abbygayle Sarah</p>
		</div>

		<div class="img-5">
			<img class="real-img-5" src="img/profile.jpg">
				<p class="desc">Tugadi, Chiellevin</p>
		</div>

		<div class="img-6">
			<img class="real-img-6" src="img/profile.jpg">
				<p class="desc">Tagaloy, Rachel</p>
		</div>

...
<html>
<head>
	<title>Women's Volley Ball</title>
	<link rel="stylesheet" type="text/css" href="volleyballwomen.css">
</head>
...
<section class="header">
	 ...
	 <div class="text-volleyball">
	 	<h1 class="volleyball">Women's Volleyball</h1>
	 </div>
	...
	<div class="container">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Ababon, Vench Kyla</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Baniqued, Jamila Bernardine</p>
		</div>

		<div class="img-3">
			<img class="real-img-3" src="img/profile.jpg">
				<p class="desc">Cerro, Raine Kristea Candiz Maxine</p>
		</div>

		<div class="img-4">
			<img class="real-img-4" src="img/profile.jpg">
				<p class="desc">Jaena, Femalyn</p>
		</div>

		<div class="img-5">
			<img class="real-img-5" src="img/profile.jpg">
				<p class="desc">Legaspi, Joyce Marianne</p>
		</div>

		<div class="img-6">
			<img class="real-img-6" src="img/profile.jpg">
				<p class="desc">Marqueses, Michelle</p>
		</div>


		<div class="img-7">
			<img class="real-img-7" src="img/profile.jpg">
				<p class="desc">Mayuga, Alliyah Kylah</p>
		</div>


		<div class="img-8">
			<img class="real-img-8" src="img/profile.jpg">
				<p class="desc">Moñeva, Althea Jane</p>
		</div>

		<div class="img-9">
			<img class="real-img-9" src="img/profile.jpg">
				<p class="desc">Moya, Cyle Gabrielle</p>
		</div>

		<div class="img-10">
			<img class="real-img-10" src="img/profile.jpg">
				<p class="desc">Negad, Arahnel</p>
		</div>

		<div class="img-11">
			<img class="real-img-11" src="img/profile.jpg">
				<p class="desc">Pasco, Kim Claus</p>
		</div>

		<div class="img-12">
			<img class="real-img-12" src="img/profile.jpg">
				<p class="desc">Reyes, Pamela</p>
		</div>
	</div>
<!-- Beach Volley -->
	 <div class="text-beach">
	 	<h1 class="beach">Women's Beach Volley</h1>
	 	<br>
		<h1 class="beach-official">2023 Official Roster</h1>
	</div>
	...
	<div class="container-beach">
		...
		<div class="img-1">
			<img class="real-img-1" src="img/profile.jpg">
				<p class="desc">Alcubilla, Shaina Marie</p>
		</div>

		<div class="img-2">
			<img class="real-img-2" src="img/profile.jpg">
				<p class="desc">Barcenas, Jessa Marie</p>
		</div>
	</div>
</body>
